# com-chilipeppr-workspace-br
A ChiliPeppr Workspace sample br.
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-br |
| Name                  | Workspace / Sample |
| Description           | A ChiliPeppr Workspace sample br. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/https://master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/root/brizzaEnv1 |
| Github URL            | http://github.com/https:/ |
| Test URL              | https://preview.c9users.io/root/brizzaEnv1/workspace.html |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-sample_br"], // the id you gave your workspace
      function(myWorkspaceBr) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Sample just got loaded.", myWorkspaceBr);
        myWorkspaceBr.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-br"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Sample"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace sample br."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/https://master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/root/brizzaEnv1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/https:/"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://brizzaEnv1-root.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
